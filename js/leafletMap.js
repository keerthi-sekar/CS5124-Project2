class LeafletMap {
  ...
  initVis() {
    ...
    vis.base_layer = L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png', {
      id: 'esri-image',
                    ...
                    .join('circle')
                        ...
                        .on('mouseover', function(event,d) { //function to add mouseover event
                            ...
                            d3.select('#tooltip')
                                ...
                                .html(`<div class="tooltip-label">Service: ${d.SERVICE_NAME}, Zipcode: ${d.ZIPCODE}</div>`);
